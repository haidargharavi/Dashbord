  ...
  return (
    <div className='features'>
      ...
      <div className="featureItem">
        ...
        <span className="featureSup">Compared to last month</span>
      </div>
      ...
      <div className="featureItem">
        ...
        <div className="featureContainer">
          ...
          <span className="featureRate">-1.4 <ArrowDownwardIcon className='featureIcon negative'/></span>
        </div>
        <span className="featureSup">Compared to last month</span>
      </div>
      ...
      <div className="featureItem">
        ...
        <div className="featureContainer">
          ...
          <span className="featureRate">+2.4 <ArrowUpwardIcon className='featureIcon '/></span>
        </div>
        <span className="featureSup">Compared to last month</span>
      </div>
